                ...
                >
                    <div className="grid gap-2">
                        ...
                        <p className="text-muted-foreground text-xs">
                            {embedded
                                ? 'Images, PDF, Word, Excel, PowerPoint, ZIP or text. Up to 50 MB each.'
                                : `Images, PDF, Word, Excel, PowerPoint, ZIP or text. Up to ${TASK_ATTACHMENT_MAX_FILES} files, 50 MB each. Video files are not supported here — upload reels in Creative review below.`}
                        </p>
                ...
                <div key={attachment.id} className="flex items-start justify-between gap-3 rounded-lg border p-3 text-sm">
                    ...
                    {attachment.can_delete && (
                        <ConfirmDelete
                            ...
                            description="This only removes a working file. Submitted deliverables are not affected."
                            trigger={
    ...
    if (embedded) {
        return (
            <section className="space-y-4">
                <div>
                    <h3 className="text-sm font-semibold">Working files</h3>
                    <p className="text-muted-foreground text-sm">Reference and draft files while you work on this task.</p>
                </div>
                {body}
            </section>
        );
