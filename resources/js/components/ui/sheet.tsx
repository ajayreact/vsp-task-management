...
const sheetVariants = cva(
    'bg-card data-[state=open]:animate-in data-[state=closed]:animate-out shadow-elevated-lg fixed z-50 gap-4 p-6 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
    {
        variants: {
            side: {
